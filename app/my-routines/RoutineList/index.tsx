...
export default function RoutineList({ type, icon, serie, customStyles, disableAll }: Props) {
  ...
  }, [isAnalysisGoing, showOverlay, relevantTasks]);

  return (
    <Stack className={classes.container} style={customStyles ? customStyles : {}}>
      <Group className={classes.titleGroup}>
        <StreakStatus completionPercent={taskCompletionPercent} icon={icon} serie={serie || 0} />
        <ButtonsGroup
      ...
      <Skeleton visible={displayComponent === "loading"} className={"skeleton"}>
        <CreateRoutineProvider>
          {displayComponent === "tasks" && <ActivateCoachButton />}
