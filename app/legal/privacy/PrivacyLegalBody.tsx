  ...
  return (
    <>
      ...
      <div>
        ...
        <h4>When and with whom do we share your information?</h4>
        <ul>
      ...
      <div>
        ...
        <h3>Types of Automatically Collected Information</h3>
        <ul>
          <li>
      ...
      <div>
        ...
        <h3>Examples of Third-Party Providers:</h3>
        <ul>
          <li>
      ...
      <div>
        ...
        <h3>For Residents of the EEA, UK, or Switzerland:</h3>
        <p>
      ...
      <div>
        ...
        <h3>What is Do-Not-Track (DNT)?</h3>
        <p>
      ...
      <div>
        ...
        <h3>Retention and Use of Collected Personal Information:</h3>
        <ul>
          <li>
        ...
        <h3>Additional Personal Information Collection:</h3>
        <p>
        ...
        <h3>Disclosure for Business or Commercial Purposes:</h3>
        <ul>
          <li>
      ...
      <div>
        ...
        <h3>New Zealand</h3>
        <p>In New Zealand, we are bound by the Privacy Act 2020.</p>
        <ul>
          <li>
        ...
        <h3>Key Points for Australia and New Zealand:</h3>
        <ul>
          <li>
        ...
        <h3>Key Points for South Africa:</h3>
        <ul>
          <li>
      ...
      <div style={{ marginBottom: rem(32) }}>
        ...
        <p>Purrma LLC, 30N Gould St Ste, Sheridan, WY 82801, United States</p>
        <p>
